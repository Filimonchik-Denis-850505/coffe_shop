...
export class BasketComponent implements OnInit {
    ...
    getTotalPrice(basket: Basket): string {
        return (basket.price * basket.count).toFixed(2);
    }
    ...
    sendOrder(): void {
        ...
        this.basketService.createOrder(this.order).subscribe(data => {
            console.log(data);
            this.responseValid(data);
            if (this.responseStatus) this.clearBasket();
            this.showPopup()
        });
    }
